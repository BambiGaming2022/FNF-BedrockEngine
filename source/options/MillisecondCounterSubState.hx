...
class MillisecondCounterSubState extends BaseOptionsMenu
{
	...
	function lmao()
	{
		...
		{
			option2 = new Option('Millisecond Color', "If unchecked, millisecond counters won't change colors.", 'millisecondColor', 'bool', coolNullBool);
		}
	}
}
